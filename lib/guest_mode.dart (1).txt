...
//
// Deliberately does NOT show Contact Support / CEO contact details —
// that lives only in the signed-in Profile tab (see main.dart), since
// guest sessions are anonymous and support requests need an account to
// act on.
