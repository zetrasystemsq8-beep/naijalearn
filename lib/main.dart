...
class NaijaLearnApp extends StatelessWidget {
  ...
  static const Color _oceanSeed = Color(0xFF0077B6); // Ocean Theme Pack (Coin Shop)
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _MenuTile(icon: Icons.auto_awesome_rounded, label: 'NAI Mentor', subtitle: 'Talk it through, get personalized guidance', onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const NaiMentorScreen()))),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _MenuTile(icon: Icons.emoji_events_rounded, label: 'World Challenge', subtitle: 'Weekly competition, 500 Cent entry', onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => WorldChallengeScreen()))),
