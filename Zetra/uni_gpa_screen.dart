...
class UniGpaScreen extends StatefulWidget {
  const UniGpaScreen({super.key, required this.ctrl});
  final UniversityController ctrl;
  @override
  State<UniGpaScreen> createState() => _GpaScreenState();
}

class _GpaScreenState extends State<UniGpaScreen> {
  ...
  Future<void> _add() async {
    ...
    await widget.ctrl.addResult(UniResult(
      ...
      builder: (context, _) {
        ...
        return Scaffold(
          ...
          body: ListView(padding: const EdgeInsets.all(16), children: [
            SegmentedButton<UniGradeScale>(
              segments: [for (final s in UniGradeScale.values) ButtonSegment(value: s, label: Text(s.label))],
              selected: {c.scale},
