...
import 'uni_course_screen.dart';
import 'uni_gpa_screen.dart';
import 'uni_discovery_screen.dart';
          ...
          appBar: AppBar(title: const Text('🎓 University'), actions: [
            IconButton(
              ...
              onPressed: () => Navigator.push(context,
                  MaterialPageRoute(builder: (_) => UniDiscoveryScreen(ctrl: ctrl))),
            ),
            IconButton(
              tooltip: 'GPA / CGPA',
              icon: const Icon(Icons.calculate_outlined),
              onPressed: () => Navigator.push(context,
                  MaterialPageRoute(builder: (_) => UniGpaScreen(ctrl: ctrl))),
            ),
          ]),
          ...
          body: ListView(padding: const EdgeInsets.all(16), children: [
            ...
            if (ctrl.courses.isEmpty)
              Card(child: ListTile(
                ...
                title: const Text('Find your courses'),
                subtitle: const Text('Search by course code, name or tutor'),
            ...
            for (final c in ctrl.courses)
              Card(child: ListTile(
                ...
                onTap: () => Navigator.push(context, MaterialPageRoute(
                    builder: (_) => UniCourseScreen(ctrl: ctrl, course: c, onAskNai: widget.onAskNai))),
              )),
            const SizedBox(height: 20),
            ...
            if (resume.isNotEmpty) ...[
              ...
              Card(child: ListTile(
                ...
                onTap: () => Navigator.push(context, MaterialPageRoute(
                    builder: (_) => UniCourseScreen(ctrl: ctrl, course: resume.first, onAskNai: widget.onAskNai))),
              )),
            ],
